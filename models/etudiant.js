...
*/
module.exports.modifierEtudiant = function (numPersonne, etudiant, callback) {
  // connection à la base
  db.getConnection(function(err, connexion){
        if(!err){
            // s'il n'y a pas d'erreur de connexion
            // execution de la requête SQL
            // il est conseillé de passer la requête dans une variable
            req = "UPDATE etudiant SET dep_num = "+etudiant.departement+", div_num = "+etudiant.annee+" WHERE per_num = "+numPersonne;
            connexion.query(req, callback);
...
*/
module.exports.deleteEtudiant = function (numPersonne, callback) {
  // connection à la base
  db.getConnection(function(err, connexion){
        if(!err){
            // s'il n'y a pas d'erreur de connexion
            // execution de la requête SQL
            // il est conseillé de passer la requête dans une variable
            req = "DELETE FROM etudiant WHERE per_num = "+numPersonne;
            connexion.query(req, callback);
